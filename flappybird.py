...
def create_pipe():
    ...
    top_pipe = pipe_surface.get_rect(midbottom=(700, random_pipe_pos - 275))
...
def score_display(game_state):
    if game_state == 'main_game':
        score_surface = game_font.render(str(int(score)), False,
                                         (255, 255, 255))
